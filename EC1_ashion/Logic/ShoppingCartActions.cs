...
namespace EC1_ashion.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        public void send(String quantity)
        {
            int value;
            value = Convert.ToInt32(quantity);
            retrieveQuantity = value;
        }
        ...
        {
            using (var db = new EC1_ashion.Models.ProductContext())
            {
                try
                {
        ...
        {
            using (var _db = new EC1_ashion.Models.ProductContext())
            {
                try
                {
